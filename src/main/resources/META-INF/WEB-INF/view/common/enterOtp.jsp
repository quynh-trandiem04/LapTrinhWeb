                    ...
                    <div class="wsus__login">
                        <form action="/enterOtp" method="post" onsubmit="return validateForm()">
                        	...
                        	<div class="wsus__login_input">
                                ...
                                <input type="otp" name="otp" id="otp" placeholder="Nhập otp" required autofocus>
                            </div>
...
<script>
    ...
    var countdownInterval = setInterval(function() {
        ...
        if (countdownTime <= 0) {
            ...
            xhr.open("POST", "/otp_register", true); // POST request
            ...
            xhr.onreadystatechange = function() {
                if (xhr.readyState == 4 && xhr.status == 200) {
                    ...
                    window.location.href = "/otp_register"; // Làm mới trang hoặc điều hướng lại trang /forgot_password
                }
            };
